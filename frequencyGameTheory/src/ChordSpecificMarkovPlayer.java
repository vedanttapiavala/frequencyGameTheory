...
public class ChordSpecificMarkovPlayer extends Player {
    ...
    private int[] currNoteInd = new int[2];
    ...
    public ChordSpecificMarkovPlayer() {
        ...
        this.currNoteInd[0] = -1;
        this.currNoteInd[1] = -1;
    }
    ...
    public double genNote() {
        ...
        if ((currNoteInd[0] == -1)) {
            ...
            return Util.noteToFreq(noteInd); //plays random note if this is the first note
        }
        ...
        for (index = 0; index < probabilities[currChord][currNoteInd[0]].length; index++) {
    ...
    protected void update(double recentPayoff) {
        ...
        double baseLinePayoff = recentPayoff;
        ...
        if (currNoteInd[0] != -1) {
            probabilities[currChord][currNoteInd[0]][currNoteInd[1]] += 4 * recentPayoff;
